...
public class Jogo 
{
    ...
    private void criarAmbientes()
    {
        ...
        fora.ajustarSaida("norte", anfiteatro);
        fora.ajustarSaida("leste", laboratorio);
        fora.ajustarSaida("sul", cantina);
        anfiteatro.ajustarSaida("oeste", fora);
        anfiteatro.ajustarSaida("acima", sotao);
        ...
        sotao.ajustarSaida("abaixo", anfiteatro);
    ...
    private void imprimirAjuda() 
    {
        ...
        System.out.println(PalavrasComando.getComandos());
    }
